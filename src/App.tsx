...
const {isDarkMode, setIsDarkMode} = useDarkMode(); // do tego masz dostęp w każdym komponencie
...
const removeFromFavorites = (contactToRemove:Contact) => {
  ...
  // prevFavorites.filter((contact) => contact.id !== contactToRemove.id)
  // )
}
 ...
 const toggleDarkMode = () => {
  ...
  return (
    ...
    <button className="show-favorites" onClick={() =>setShowFavorites(!showFavorites)}>{showFavorites ? "Hide Favorite Contacts" : "Show Favorite Contacts"}</button>
